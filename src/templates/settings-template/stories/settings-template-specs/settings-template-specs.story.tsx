...
const specs = [
  ...
  { property: "Section header", value: "label/large, $onSurfaceVariant" },
  { property: "Sections", value: "Divided by Divider component" },
  { property: "Collapsible", value: "Uses Accordion.Item" },
  { property: "Bottom padding", value: "16 dp" },
];
...
const meta: Meta = {
  title: "templates/settings-template/specs",
  component: Specs,
  tags: ["autodocs", "!dev"],
  parameters: {
    design: {
